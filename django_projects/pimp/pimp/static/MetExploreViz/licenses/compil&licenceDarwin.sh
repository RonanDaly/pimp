...
execScript(){
	...
	echo "Any repertory named \"$1\"!";
		...
		copyrightJSandCSS(){
			...
			t="\/*<newLine>"
			t="$t This file is part of MetExploreViz <newLine><newLine>"
			t="$t Copyright © $year INRA <newLine>"
			t="$t Contact: http:\/\/metexplore.toulouse.inra.fr\/metexploreViz\/doc\/contact <newLine>"
			t="$t GNU General Public License Usage <newLine>"
			t="$t This file may be used under the terms of the GNU General Public License version 3.0 as <newLine>"
			t="$t published by the Free Software Foundation and appearing in the file LICENSE included in the <newLine>"
			t="$t packaging of this file. <newLine>"
			t="$t Please review the following information to ensure the GNU General Public License version 3.0 <newLine>"
			t="$t requirements will be met: http:\/\/www.gnu.org\/copyleft\/gpl.html. <newLine>"
			t="$t If you are unsure which license is appropriate for your use, please contact us <newLine>"
			t="$t at http:\/\/metexplore.toulouse.inra.fr\/metexploreViz\/doc\/contact<newLine>"
			t="$t Version: $version <newLine>"
			t="$t Build Date: $dateProd <newLine>"
			t="$t *\/<newLine>"
