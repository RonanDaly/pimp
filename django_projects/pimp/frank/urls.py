...
urlpatterns = patterns ('',
    ...
    url(r'^my_fragmentation_sets/(?P<fragmentation_set_name_slug>[\w\-]+)/(?P<annotation_tool_slug>[\w\-]+)/define_annotation_query_paramaters/$',
        views.define_annotation_query, name = 'define_annotation_query'),
    url(r'^my_fragmentation_sets/(?P<fragmentation_set_name_slug>[\w\-]+)/(?P<peak_name_slug>[\w\-]+)/$',
        views.peak_summary, name = 'peak_summary'),
    url(r'^my_fragmentation_sets/(?P<fragmentation_set_name_slug>[\w\-]+)/(?P<peak_name_slug>[\w\-]+)/msn_spectra_plot.png/$',
        views.make_frag_spectra_plot, name = "make_spectra_plot"),
    url(r'^my_fragmentation_sets/(?P<fragmentation_set_name_slug>[\w\-]+)/(?P<peak_name_slug>[\w\-]+)/(?P<annotation_id>[\w\-]+)/specify_preferred_annotation/$',
